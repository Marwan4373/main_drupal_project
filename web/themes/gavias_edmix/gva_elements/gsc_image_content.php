   ...
   class gsc_image_content{
      ...
      public static function sc_image_content( $attr, $content = null ){
         ...
         extract(shortcode_atts(array(
            ...
            'background'         => '',
            'link'               => '',
            'label_link'         => 'Read more',
            'target'             => '',
            'skin'               => 'skin-v1',
            'el_class'           => '',
            'animate'            => ''
         ), $attr));
         $label_link = !empty($label_link) ? $label_link : 'Read more';
         // target
         if( $target =='on' ){
        ...
        ob_start();
         ...
         <div class="gsc-image-content <?php print $el_class; ?>" <?php print gavias_print_animate_aos($animate) ?>>
            ...
            <div class="content">
               ...
               <?php if($link){ ?>
                  <div class="action"><a <?php print $target ?> href="<?php print $link ?>"><?php print $label_link ?></a></div>
               <?php } ?>  
            </div>  
         </div>
