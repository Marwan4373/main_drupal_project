...
if(!class_exists('gsc_gmap')):
   class gsc_gmap{
      ...
      <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDIuJVwBxTLKGo7oDBIkkFwUBFguVat7Ag"></script>
      <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_edmix')) ?>/vendor/gmap3.js"></script>
      <script type="text/javascript" src="<?php print (base_path() . \Drupal::service('extension.list.theme')->getPath('gavias_edmix')) ?>/vendor/jquery.ui.map.min.js"></script>
